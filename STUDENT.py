...
height_mean = statistics.mean(reading_list)

#Median for height and weight
height_median = statistics.median(reading_list)

#Mode for height and weight
height_mode = statistics.mode(reading_list)
...
height_std_deviation = statistics.stdev(reading_list)
...
reading_list_of_data_within_1_std_deviation = [result for result in reading_list if result > height_first_std_deviation_start and result < height_first_std_deviation_end]
reading_list_of_data_within_2_std_deviation = [result for result in reading_list if result > height_second_std_deviation_start and result < height_second_std_deviation_end]
reading_list_of_data_within_3_std_deviation = [result for result in reading_list if result > height_third_std_deviation_start and result < height_third_std_deviation_end]
